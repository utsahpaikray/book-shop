...
export class DashboardService {
  ...
  private controllerbooks = 'https://www.googleapis.com/books/v1/volumes?'
 ...
 public getBooks(query?:string): Observable<any>{
  ...
  return this._http.get<any>(this.controllerbooks+ 'q='+ query +'&printType=magazines&orderBy=newest&maxResults=40&key=AIzaSyCH7cqaX1mXq11OGJVzttCveAuc8jGP8-U');
 }
